...
import com.nstoya.thrillio.constants.Gender;
import com.nstoya.thrillio.constants.MovieGenre;
import com.nstoya.thrillio.constants.UserType;
...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[4] = UserManager.getInstance().createUser(1004, "user4@semanticsquare.com", "test", "Dheeru2", "M",
				Gender.MALE, UserType.CHIEF_EDITOR);
	}

	private static void loadWebLinks() {
		bookmarks[0][0] = BookmarkManager.getInstance().createWeblink(2000, "Taming Tiger, Part 22",
