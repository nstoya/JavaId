...
public class ReflectionDemo {
	...
	public static void demoClassObjectAccess() {
	    ...
	    Class clazz = null;
	    try {
		    clazz = Class.forName("com.nstoya.jvm.User");		    
		...
		System.out.println("clazz.getDeclaredMethods().length: " + clazz.getDeclaredMethods().length);
	...
	public static void main(String[] args) throws Exception {
		...
		demoCoreReflection(Class.forName("com.nstoya.jvm.User"));
	}
}
